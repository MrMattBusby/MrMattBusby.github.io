...
*Internal Research & Development (IR&D) application Platform-as-a-Service (PaaS) High-Fidelity Digital Twin (HFDT) team SAFe Agile Product Owner and software engineering integration lead for 777X avionics systems. Principal-level position.*
...
**Aero Simulation, Inc.**  |  Tampa, FL  
*Technical project manager and lead systems engineer managing cross-functional 20-person team across 5+ major trainer modifications valued at $25M across 2 programs at 5 OCONUS and CONUS facilities. Junior through mid-level progression.*

- Successfully delivered 5 projects valued at $25M+ within Period of Performance and budget constraints
- Directed complex avionics technology refresh at OCONUS location, delivering early with low overhead, record profit margin, and zero warranty claims
...
- Executed multiple Aircraft-to-Flight Simulator concurrency upgrades using laboratory Software-in-the-Loop (SIL) environments, satisfying 1k+ traceable requirements
